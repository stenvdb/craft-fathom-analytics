...
namespace stenvdb\fathomanalytics\assetbundles\reportwidget;
...
class ReportWidgetAsset extends AssetBundle
{
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@stenvdb/fathomanalytics/assetbundles/reportwidget/dist";
        ...
        $this->js = [
            'js/reportwidget.min.js',
        ];

        $this->css = [
            'css/reportwidget.min.css',
        ];
