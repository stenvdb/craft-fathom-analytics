...
namespace stenvdb\fathomanalytics\assetbundles\fathomsettings;
...
class SettingsAsset extends AssetBundle
{
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@stenvdb/fathomanalytics/assetbundles/fathomsettings/dist";
        ...
        $this->js = [
            'js/fathomsettings.min.js',
        ];

        $this->css = [
            'css/fathomsettings.min.css',
        ];
